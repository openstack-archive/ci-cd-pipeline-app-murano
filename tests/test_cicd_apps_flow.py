...
class MuranoCiCdTest(base.MuranoTestsBase):
    ...
    def test_run_full_cicd(self):
        ...
        project_config_location = "/tmp/project-config"
        ...
        self.add_to_file(
            '{0}/jenkins/jobs/project.yaml'.format(project_config_location),
            new_job
        )
